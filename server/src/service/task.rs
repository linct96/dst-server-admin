...
pub async fn update_system_info() {
    ...
    system_info.disk_used = (disk_info.used() as f32 / (1024 * 1024 * 1024) as f32 * 10.0).round() / 10.0;
    system_info.disk_total = (disk_info.total() as f32 / (1024 * 1024 * 1024) as f32 * 10.0).round() / 10.0;
